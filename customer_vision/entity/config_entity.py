...
from customer_vision.constants.training_pipeline import *
...
class ModelEvaluationConfig:
    model_evaluation_dir: str = os.path.join(
        training_pipeline_config.artifacts_dir, "model_evaluation"
    )
    
    threshold = MODEL_EVALUATION_THRESHOLD
    
    iou_threshold = MODEL_EVALUATION_IOU_THRESHOLD
    
    min_map_threshold: float = 0.6  # Minimum mAP50 threshold for model acceptance
